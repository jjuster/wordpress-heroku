...
<div class="homepage-post tall-post">
	<a href="{$post->permalink}">
		<img src="https://s3.amazonaws.com/cdn.pradux.com/uploads/1441051534_blank-768x1226.png" data-pradux-ignore="true" style="background-image:url({$post->featured_image})">
	</a>
	<div class="bottom-text">
		<div class="category">{$post->category}</div>
